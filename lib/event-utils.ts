import type { DateGroup, EventCategory, FRKAEvent } from './types';
 ...
 */
export const isNewEvent = (event: FRKAEvent, now: Date | number = Date.now()): boolean => {
 ...
 */
export const eventDurationDays = (event: FRKAEvent): number =>
...
const groupByStartDate = (events: FRKAEvent[]): DateGroup[] => {
...
export const groupEventsByDate = (events: FRKAEvent[]): DateGroup[] =>
...
export const groupEventsByRecency = (events: FRKAEvent[]): DateGroup[] =>
